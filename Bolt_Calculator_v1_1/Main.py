...
class MainWindow(Frame):
    ...
    def _update_cb(self) -> None:
        ...
        None
        """
        # Clearing lists to be displayed in the comboboxes
        self._mat_cb.clear()
        self._mat_nr_cb.clear()
    ...
    def _update_statusbar(self, status: str) -> None:
        """
        Update the status bar with date and time stamp and the given status
        information.
        ...
        ...
        ----------
        status:str
            status information to be printed to the status bar
    ...
    def _calc(self, _: Event) -> None:
        ...
        if report == 1:
            try:
                ...
                report = Report(self._cwd, bolt, calc, self._paths.get(
